...
public class Config {
    ...
    public static String arduino_move_forward_command = "A";
    public static String arduino_turn_left_command = "L";
    public static String arduino_turn_right_command= "R";

    public static String algorithm_start_fastest_path = "FP_START";
    public static String algorithm_start_exploration = "EX_START";
