package shadowbotz.DORA.View.Bluetooth;
...
public class DeviceListActivity extends AppCompatActivity {
    ...
    private ProgressBar progressBarForNewDevices;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBarForNewDevices = findViewById(R.id.progressBarForNewDevices);
        ...
        scanButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                doDiscovery();
                v.setEnabled(false);
                progressBarForNewDevices.setVisibility(View.VISIBLE);
            }
        });
