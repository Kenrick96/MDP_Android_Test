...
import shadowbotz.DORA.BluetoothObserverSubject.BluetoothSubject;
import shadowbotz.DORA.Config;
import shadowbotz.DORA.Controller.BluetoothController;
import shadowbotz.DORA.Controller.PersistentController;
import shadowbotz.DORA.Model.BluetoothMessage;
import shadowbotz.DORA.R;
import shadowbotz.DORA.Service.BluetoothMessagingService;
import shadowbotz.DORA.View.Bluetooth.BluetoothLogActivity;
import shadowbotz.DORA.View.Bluetooth.DeviceListActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if (actionBar != null) {
            actionBar.setTitle("DORA - " + Config.current_bluetooth_state);
        }
    }
